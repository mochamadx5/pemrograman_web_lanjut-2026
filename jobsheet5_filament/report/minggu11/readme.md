...
Fitur pencarian ditambahkan menggunakan method `searchable()` pada kolom teks (seperti Title, Slug, dan Category). Hasil pencarian akan memfilter data di tabel secara otomatis dan *real-time* saat pengguna mengetikkan kata kunci.
![search](img/20.png)
